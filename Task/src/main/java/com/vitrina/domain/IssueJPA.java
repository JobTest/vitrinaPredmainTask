...
@Entity
public class IssueJPA implements Issue {
    ...
    public IssueJPA(){}
    public IssueJPA(Integer Id, int ParentId, int ProjectId, String ProjectName, int TrackerId, String TrackerName, int StatusId, String StatusName, int FixedVersionId, String FixedVersionName, String Subject, String StartDate, String DueDate){
        this.Id = Id;
