...
/**
 * Created by Саша on 31.07.2015.
 ** {@link http://habrahabr.ru/post/243155/}
 * {@link http://habrahabr.ru/post/172239/}
 * ****************************************
 * Шесть простых примеров по Mockito
 *
 * {@link http://www.slideshare.net/nunafig/mockito-12079903}
 */
public class MockitoTests {
    ...
    public void OutputStreamWriter_Buffers_And_Forwards_To_OutputStream() throws IOException {
        ...
        osw.write('a');
        osw.flush();
        /* не можем делать так, потому что мы не знаем, насколько длинным может быть массив verify(mock).write(new byte[]{'a'},0,1); */
